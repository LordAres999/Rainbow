    ...
    <main class="flex-1 ml-64 p-8 bg-white">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-10 rounded-xl overflow-hidden">
          <img
            src="@/assets/images/FutureImage.png"
            alt="Featured"
      ...
      <Transition name="fade">
        ...
        >
          <Transition name="pop" appear>
            <div
              v-if="showModal"
              class="w-full max-w-2xl bg-rose-50/60 rounded-2xl p-4 sm:p-6"
              @click.stop
            >
              <p class="text-sm text-gray-400 mb-3 px-1">New Post</p>
              ...
              <div class="bg-white rounded-xl shadow-sm">
                <textarea
                  ...
                  rows="5"
                  class="w-full resize-none border-none rounded-t-xl px-5 pt-5 pb-2 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-0"
                ></textarea>
                ...
                <div class="flex items-center justify-between px-5 py-4 border-t border-gray-100">
                  ...
                  <button
                    ...
                    @click="submitPost"
                    class="px-7 py-2.5 bg-indigo-600 text-white rounded-full text-sm font-semibold hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                  >
                    Post
                  </button>
                </div>
...
watch(
  () => showModal.value,
  (isOpen) => {
    if (isOpen) postText.value = ''
  },
)

function submitPost() {
  if (!postText.value.trim()) return
  console.log('New post:', postText.value)
  postText.value = ''
  showModal.value = false
}

function handleTextFormat() {
  console.log('Text format clicked')
...
function handleDraw() {
  ...
  // Enable drawing mode
  alert('Drawing mode coming soon!')
}
